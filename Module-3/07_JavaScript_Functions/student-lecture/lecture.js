...
function arrayFunctions()
{
  // Split a string into an array
    ...
    console.log('*** ***\r\narray.splice gets a "sub-array" and removes those elements.' );
    // splice here...
    arr = words.splice(3, 4, " middle", "of", "the")
    printArray(arr);
    printArray(words);
 ...
 */
function multiplyTogether(num1 = 0, num2 = 0){
  return num1 * num2;
}
...
answer = tripleIt(333);
console.log(`The tripleIt answer is ${answer}`)
...
console.log(`The quadrupleIt answer is ${answer}`)
...
function upperName(people) {
  return people.map( (person) => {
    ...
    return {Name: person.name, BirthYear: 2021-person.age};
  });
}
...
// Sort the array
/**
 * Fuction to sort people by age, descending
 * @param {array} people The array to sort
 * @returns A sorted array of people by height
 */
