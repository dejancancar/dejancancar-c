<template>
  <div class="main">
    ...
    <!-- A single review -->
    <div class="review" v-for="review in reviews" v-bind:key="review.id" v-bind:class="{fav: review.favorite}">
...
export default {
  name: "product-review",
  //DATA IS A FUCTION THAT RETURNS AN OBJECT full of properties
  data() {
    return {
